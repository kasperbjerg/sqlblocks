...
export const Route = createLazyFileRoute('/learn/jonah')({
  component: About,
});
  ...
  return (
    <>
      <Exercise
        ...
        hint={
          <p>
            Hint: Du skal bruge to(!!) <b>INNER JOIN</b>-blokke for at løse
            denne sidste øvelse.
          </p>
        }
        feedbackText={
        ...
        completeConditionsResult={[
          [
            '[{"Sang":"Honey","Album":"Brothers","Kunstner":"Jonah Blacksmith"},{"Sang":"Ghost","Album":"Jonah Blacksmith","Kunstner":"Jonah Blacksmith"},{"Sang":"Daughter of Jonah","Album":"Jonah Blacksmith","Kunstner":"Jonah Blacksmith"}]',
          ],
        ]}
