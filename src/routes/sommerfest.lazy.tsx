    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              De tre venner Lars K, Jesper og Lars M er tovholdere på første
              årgangs sommerfest og har lavet en tabel for at holde styr på
              sagerne. <br></br>
        ...
        feedbackText={
          <>
            <p className="text-[#a6a65b]">God start</p>
          </>
        }
        ...
        initialXml={`
              ...
              <block type="insert_into_only_values" id="!+nn4#*jpLCi@lLjbmh"><field name="table_NAME">sommerfest</field><value name="VALUES"><block type="value" id="wJBl2dF6c,ctG.B(E:#"><field name="NAME1">'Lav invitationer'</field><value name="NAME"><block type="value" id="~/kF:M!0pW3=XuCjaX"><field name="NAME1">'Lille Lars'</field><value name="NAME"><block type="value" id="a@4Cxp^,NhJs0NkQUsVY"><field name="NAME1">0</field></block></value></block></value></block></value><next>
              <block type="select_open" id="S$2HTf((iyr-ObfSy/0"><field name="table">sommerfest</field><value name="NAME"><block type="column" id="Uo4s0~uKl2FffH/sT4y"><field name="NAME1">*</field></block></value></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></next></block></xml>          `}
        toolBox={
          <>
