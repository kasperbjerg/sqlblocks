...
function About() {
  return (
    <>
      <Exercise
        exercise={'medlemmer'}
        nextExercise={'lazyboy'}
        description={
          <>
            <p>
              Lederen af centret har brug for et overblik. <br />
              Hun skal bruge en tabel der viser hver <b>kategori</b> efterfulgt
              af det samlede antal tilmeldte til hver kategori som <b>tilmeldte_i_alt</b>.<br />
              Brug <b>SUM</b>, <b>AS</b> og <b>GROUP BY</b> til at løse denne
              opgave for hende.
            </p>
          </>
        }
        ...
        feedbackText={
          <>
            <p className="text-[#5b80a6]">Lige præcis :)</p>
          </>
        }
        completeConditionsSql={[
          [
            'SELECTkategori,SUM(tilmeldte)AStilmeldte_i_altFROMtræningGROUPBYkategori',
          ],
        ]}
