    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              Tabellen nedenfor er et overblik over træningsmulighederne på et
              lille fitness-center. <br />
              Asger har haft en hård uge i skolen og trænger til at få brugt
              noget energi. Han vil enten deltage på et <b>Styrke</b>-hold eller
              et hold med en varighed på mere en 60 minutter. Lav en{' '}
              <b>SELECT *</b>-forespørgsel med <b>OR</b>-blok som kan hjælpe
              ham!
            </p>
          </>
        }
        hint={
          <p>
            Hint: Da det skal være MERE end 60 minutter skal <b>Cycling</b> jo
            ikke være med.
          </p>
        }
        feedbackText={
          <>
            <p className="text-[#D0664f]">Så er du igang igen.. fedt!</p>
          </>
        }
        ...
        completeConditionsResult={[
          [
            '[{"id":3,"hold":"Bootylicious","kategori":"Styrke","varighed":30,"tilmeldte":6},{"id":5,"hold":"Dance Aerobic","kategori":"Dans","varighed":75,"tilmeldte":8},{"id":7,"hold":"Vinyasa","kategori":"Yoga","varighed":70,"tilmeldte":13},{"id":8,"hold":"Crosstraining","kategori":"Styrke","varighed":60,"tilmeldte":7}]',
          ],
