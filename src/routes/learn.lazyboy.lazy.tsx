...
export const Route = createLazyFileRoute('/learn/lazyboy')({
  component: About,
});
    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              ...
              for lang tid.
              <br />
              Lav en tabel der viser <b>kategori</b> efterfulgt af{' '}
              <b>gennemsnit_af_varighed</b> og som kun viser de kategorier hvor
              den gennemsnitlige varighed af holdene er under 50 minutter.
              Sorter så kategorien med lavest gennemsnit er øverst.
            </p>
          </>
        }
        hint={<p>Hint: Brug AVG-blokken og GROUP BY ... HAVING ...</p>}
        feedbackText={
          <>
            <p className="text-[#5ba699]">Yew!!!</p>
          </>
        }
        ...
        completeConditionsResult={[
          [
            '[{"kategori":"Styrke","gennemsnit_af_varighed":45},{"kategori":"Kondition","gennemsnit_af_varighed":47.5}]',
          ],
