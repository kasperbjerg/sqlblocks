...
export const Route = createLazyFileRoute('/learn/tracks')({
  component: About,
});
    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              ...
              Brug <b>INNER JOIN</b> til at samle <b>tracks</b> og{' '}
              <b>kunstnere</b> til én tabel
            </p>
          </>
        }
        hint={
          <p>
            Hint: Husk tabelnavn.kolonnenavn-notationen i <b>JOIN</b>-blokken og
            at sortere tabellen til sidst
          </p>
        }
        feedbackText={
          <>
            <p className="text-[#805ba6]">Mega sejt.. Godt kæmpet!</p>
          </>
        }
        ...
        completeConditionsResult={[
          [
            '[{"Sang":"yes, and?","Kunstner":"Ariana Grande"},{"Sang":"Just Look Up","Kunstner":"Ariana Grande"},{"Sang":"Leap Of Faith","Kunstner":"Christopher"},{"Sang":"Hope This Song Is For You","Kunstner":"Christopher"},{"Sang":"Latch","Kunstner":"Disclosure feat. Sam Smith"},{"Sang":"Ghost","Kunstner":"Jonah Blacksmith"},{"Sang":"Daughter of Jonah","Kunstner":"Jonah Blacksmith"},{"Sang":"Honey","Kunstner":"Jonah Blacksmith"}]',
          ],
        ]}
