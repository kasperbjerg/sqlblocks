...
export const Route = createLazyFileRoute('/learn/singles')({
  component: About,
});
    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              Som du måske lagde mærke til er tre af sangene singles. Nu skal du
              lave en tabel med én kolonne <b>Singles</b>, der indeholder disse
              tre sange.
              <br></br>
        ...
        hint={
          <p>
            Hint: Det går ikke med <b>INNER JOIN</b> her, prøv de andre.
          </p>
        }
        feedbackText={
          <>
            <p className="text-[#a65b99]">
              Mark Zuckerberg ryster i bukser over dine coding-skills ;)
            </p>
          </>
        }
        ...
        completeConditionsResult={[
          [
            '[{"Singles":"Hope This Song Is For You"},{"Singles":"Just Look Up"},{"Singles":"Leap Of Faith"}]',
          ],
        ]}
