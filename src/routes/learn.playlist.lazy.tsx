...
export const Route = createLazyFileRoute('/learn/playlist')({
  component: About,
});
    ...
    <>
      <Exercise
        ...
        description={
          <>
            <p>
              Bruger du spotify? I de næste øvelser skal du arbejde med en
              database som indeholder information om forskellige sange, kunstere
              og albums.
              <br></br>
              Som du kan se er der en tabel til sange der hedder <b>tracks</b>,
              samt en tabel til <b>kunstere</b> og en til <b>albums</b>.
              <br></br>
              Start med at vælge alle kolonner fra <b>tracks</b> for at få et
              overblik, men begræns tabellen med <b>LIMIT</b> så du kun ser de 3
              første rækker.
            </p>
          </>
        }
        hint={
          <p>
            Hint: Læg mærke til at den første sang er en single. Derfor er{' '}
            <b>albumId</b> tom hvilket svarer til værdien <b>NULL</b>. (Dette
            skal du bruge senere)
          </p>
        }
        feedbackText={
          <>
            <p className="text-[#5ba699]">
              Sådan, men kunstnerId 4 er jo lidt underlig, så hop videre til
              næste øvelse.
            </p>
          </>
        }
        completeConditionsSql={[['SELECT*FROMtracksLIMIT3']]}
